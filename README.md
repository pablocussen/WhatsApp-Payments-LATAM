...
| **Testing** | Jest 29 · ts-jest · v8 coverage (486 tests, 29 suites, 100% branches) |
...
| `npm test` | 486 tests (29 suites — unit + integración) |
...
├── tests/
│   ├── unit/                   # 28 suites · 486 tests (todos los servicios + middlewares)
...
- **Tests**: 486/486 pasando (29 suites — todos los servicios + middlewares + rutas HTTP, **100% branch coverage**)
