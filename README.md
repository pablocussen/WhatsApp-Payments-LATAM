...
[![Tests](https://img.shields.io/badge/tests-509%2F509%20passing-25D366)](https://github.com/pablocussen/WhatsApp-Payments-LATAM/actions/workflows/ci.yml)
...
| **Testing** | Jest 29 · ts-jest · v8 coverage (509 tests, 29 suites, 100% branches) |
...
| `npm test` | 509 tests (29 suites — unit + integración) |
...
├── tests/
│   ├── unit/                   # 28 suites · 509 tests (todos los servicios + middlewares)
...
- **Tests**: 509/509 pasando (29 suites — todos los servicios + middlewares + rutas HTTP, **100% branch coverage**)
